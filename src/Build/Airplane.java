...
public class Airplane {
    ...
    public Airplane(java.lang.String manufacturer, int year, int length, int weight) {
        this.manufacturer = manufacturer;
        this.year = year;
        this.length = length;
        this.weight = weight;
    ...
    public String toString(){
        return (" Manufacturer: "+manufacturer+" Year of create: "+ year+" Length: "+length+" Weight: "+ weight+" Fuel: "+ fuel);
    }
}
